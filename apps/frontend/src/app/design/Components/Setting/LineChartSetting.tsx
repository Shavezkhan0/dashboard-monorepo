...
const LineChartSetting = ({ initialData, onUpdate, onClose }) => {
    ...
    useEffect(() => {
        ...
        if (initialData) {
            setGraphData(prev => ({
                ...prev,
                showLegend: initialData.showLegend ?? true, // Initialize legend toggle
            }));
    ...
    // This is the new data processing logic from AddLineChart
    ...
    return (
        <div className="pr-2 h-full bg-white border-r border-gray-200 flex flex-col shadow-lg">
            <div className="flex items-center justify-between px-4 py-2 border-b-2 border-gray-200 ">
                <h2 className="text-lg font-semibold text-black">Edit Line Chart</h2>
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="border border-gray-200 rounded-lg p-2 bg-gray-50">
                            ...
                            {storedDataSets.length > 0 ? (
                                ...
                                <div className="text-center py-4 text-gray-500"><p className="text-sm">No datasets available</p></div>
                            )}
                        </div>
                        ...
                        {selectedDataSet && (
                            <div className="space-y-4 p-4 border bg-white rounded-lg">
                                {/* X-Axis */}
                                <div>
                                    <label className="block text-sm font-medium text-gray-600 mb-2">X-Axis (Category)</label>
                                ...
                                {/* Y-Axis */}
                                <div>
                                    <label className="block text-sm font-medium text-gray-600 mb-2">Y-Axis (Values)</label>
                                    <div className="max-h-36 overflow-y-auto p-2 border rounded">
