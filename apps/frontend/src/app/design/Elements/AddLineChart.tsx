...
const AddLineChart = ({ onClose }) => {
    ...
    const [dataSource, setDataSource] = useState('default'); // Changed from no state to 'default'
                    ...
                    {chartProps.isEmpty ? (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                            ...
                            <p className="text-xs text-blue-700 mt-1">
                                Default chart preview shown. Select a dataset above to configure your line chart.
                            </p>
                        </div>
                    ) : (
