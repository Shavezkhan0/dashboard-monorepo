                                ...
                                <div>
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="rounded border-gray-300"
                                        />
                                        <span className="text-sm text-gray-700">Show X-Axis Title</span>
                                    </label>
                                </div>
                                <div>
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="rounded border-gray-300"
                                        />
                                        <span className="text-sm text-gray-700">Show Y-Axis Title</span>
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <div className="space-y-4 p-4 border bg-gray-50 rounded-lg">
            <div className="flex items-center justify-between">
                <h4 className="font-semibold text-gray-700">Configure Bar Chart</h4>
                <button 
                    onClick={onBack}
