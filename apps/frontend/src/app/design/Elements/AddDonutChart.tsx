        ...
        <div className="space-y-4">
            ...
            {parsedData ? (
                ...
                <div className="space-y-4">
                    ...
                    {!chartProps.isEmpty && (
                        <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                            <h4 className="font-medium text-gray-700 mb-3">Chart Customization</h4>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    >
                                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${chartProps.showLegend ? 'translate-x-6' : 'translate-x-1'}`} />
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    >
                                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${chartProps.showValues ? 'translate-x-6' : 'translate-x-1'}`} />
                                    </button>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full"
                                    />
                                    <div className="text-xs text-gray-500 mt-1">{chartProps.innerRadius ?? 50}%</div>
                                </div>
                            </div>
                        </div>
                    )}
        ...
        <div className="space-y-4 p-4 border bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <label className="block text-sm font-medium text-gray-600 mb-2">Legend (Categories)</label>
                ...
                <div>
                    ...
                    <label className="block text-sm font-medium text-gray-600 mb-2">Values (Slice Sizes)</label>
