          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center space-x-1 px-6 py-3 text-indigo-600 dark:text-indigo-400 border-2 border-indigo-300 dark:border-indigo-600 bg-blue-50 dark:bg-blue-900/20
                rounded-md
