    ...
    return (
        <div className="pr-2 h-full bg-background border-r border-gray-200 flex flex-col shadow-lg">
            <div className="flex items-center justify-between px-4 py-2 border-b-2 border-gray-200">
                <h2 className="text-lg font-semibold text-foreground">Edit Bar Chart</h2>
                    ...
                    <div className="p-4 space-y-4">
                                    ...
                                    {selectedDataSet ? (
                                        ...
                                        <div className="space-y-2 max-h-40 overflow-y-auto">
                                            {storedDataSets.map(dataSet => (
                                                <button key={dataSet.id} onClick={() => handleDataSetSelect(dataSet)} className="w-full text-left p-2 text-sm bg-background border border-border rounded hover:bg-indigo-500/10 dark:hover:bg-muted hover:border-indigo-300 transition-colors">
                        ...
                        {selectedDataSet && (
                            <div className="space-y-4 p-4 border bg-background rounded-lg">
                                {/* X-Axis */}
                                <div>
                                    <label className="block text-sm font-medium text-muted-foreground mb-2">X-Axis (Categories)</label>
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        <label className="block text-sm font-medium text-muted-foreground">Y-Axis (Values)</label>
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="border border-border rounded-lg p-4">
                            ...
                            {expandedSections.properties && (
                                <div className="mt-3 space-y-3">
                                    <div>
                                        <label className="block text-xs text-muted-foreground mb-1">Bar Width</label>
                                        <input
                                            type="range"
                                            min="0.1"
                                            max="1"
                                    ...
                                    <div>
                                        <label className="block text-xs text-muted-foreground mb-1">Bar Style</label>
                                        <select
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-muted-foreground">Data Labels</span>
                                        <button
                                    ...
                                    {graphData.showDataLabels !== false && (
                                        <div>
                                            <label className="block text-xs text-muted-foreground mb-1">Label Position</label>
                                            <select
