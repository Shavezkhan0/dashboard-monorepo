    ...
    return (
        <div className="pr-2 h-full bg-background border-r border-gray-200 flex flex-col shadow-lg">
            <div className="flex items-center justify-between px-4 py-2 border-b-2 border-gray-200">
                <h2 className="text-lg font-semibold text-foreground">Edit Treemap</h2>
            ...
            <div className="flex border-b border-gray-200">
                <button
                    ...
                    ${activeTab === 'data'
                            ? 'text-blue-600 bg-muted after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-full after:bg-gradient-to-r after:from-blue-800 after:via-indigo-700 after:to-purple-600 after:content-[""]'
                ...
                {activeTab === 'customize' && (
                    ...
                    <div className="border border-border rounded-lg p-4">
                        ...
                        {expandedSections.details && (
                            <div className="mt-3 space-y-3">
                                <div className="flex items-center justify-between">
                                        ...
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-background transition-transform ${graphData.showTitle ? 'translate-x-6' : 'translate-x-1'}`}
                                            />
                                    </button>
                                </div>
                                    ...
                                    <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full p-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-foreground"
                        ...
                        <div className="border border-border rounded-lg p-4">
                            ...
                            >
                                <h3 className="text-sm font-medium text-foreground">Data Labels</h3>
                            ...
                            {expandedSections.dataLabels && (
                                <div className="mt-3 space-y-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-background transition-transform ${graphData.showDataLabels !== false ? 'translate-x-6' : 'translate-x-1'}`}
                                            />
                </button>
            </div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-background transition-transform ${graphData.showValues !== false ? 'translate-x-6' : 'translate-x-1'}`}
                                            />
                    </button>
                </div>
            </div>
            ...
            <div>
                ...
                <select 
                    ...
                    className="w-full p-2 border border-gray-300 rounded text-sm text-foreground"
                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-muted-foreground">Enable Shades</span>
                                        <button
                                        ...
                                        >
                                            <span
                                                className={`inline-block h-4 w-4 transform rounded-full bg-background transition-transform ${graphData.enableShades !== false ? 'translate-x-6' : 'translate-x-1'}`}
                                            />
                                        </button>
                                    </div>
                                </div>
