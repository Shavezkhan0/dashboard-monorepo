...
import BarChartWidget from '@/components/design/widgets/BarChartWidget'; // Use the updated Power BI version
                                ...
                                <div>
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="rounded border-border"
                                        />
                                        <span className="text-sm text-foreground">Show X-Axis Title</span>
                                    </label>
                                </div>
                                <div>
                                    <label className="flex items-center space-x-2">
                                        <input
                                            ...
                                            className="rounded border-border"
                                        />
                                        <span className="text-sm text-foreground">Show Y-Axis Title</span>
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <div className="space-y-4 p-4 border bg-muted rounded-lg">
            <div className="flex items-center justify-between">
                <h4 className="font-semibold text-foreground">Configure Bar Chart</h4>
                <button 
                    onClick={onBack}
