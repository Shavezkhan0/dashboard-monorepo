...
function AreaChartWidget({
    ...
    fillOpacity = 0.3 // New property for area fill opacity
}) {
    ...
    const data = {
        ...
        datasets: datasets.map((ds, index) => ({
            ...
            backgroundColor: ds.color ? hexToRgba(ds.color, fillOpacity) : `hsla(${index * 137.508}, 50%, 50%, ${fillOpacity})`,
            borderWidth: strokeWidth,
            borderDash: getBorderDash(lineStyle),
            fill: true, // Key property for area charts
            tension: 0.4, // Smooth curves for area charts
    ...
    const options = {
        ...
        interaction: {
            intersect: true, // Only show data for the line being hovered
            mode: 'point', // Only show single point data
        },
        plugins: {
            legend: {
